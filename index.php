			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav align-items-center text-center ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link d-inline-flex align-items-center" href="./mint.blade.php">
								<span class="nav-link__text">Mint</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link d-inline-flex align-items-center" href="./history.blade.php">
								<span class="nav-link__text">History</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link d-inline-flex align-items-center" href="./buy.blade.php">
								<span class="nav-link__text">Buy</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link d-inline-flex align-items-center" href="./pre-sale.blade.php">
